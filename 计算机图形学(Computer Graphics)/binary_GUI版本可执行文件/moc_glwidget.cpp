...
QT_MOC_LITERAL(1, 9, 10), // "changeMode"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 4), // "Mode"
QT_MOC_LITERAL(4, 26, 1) // "m"

    },
    "GLWidget\0changeMode\0\0Mode\0m"
};
...
void GLWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (GLWidget::*_t)(Mode );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&GLWidget::changeMode)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void GLWidget::changeMode(Mode _t1)
{
